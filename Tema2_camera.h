    ...
    class Camera_Tema2
    {
     public:
        ...
        void RotateFirstPerson_OX(float angle)
        {
            ...
            glm::vec3 newvect = glm::rotate(glm::mat4(1.0f), angle, right) * glm::vec4(forward, 1);
        ...
        void RotateFirstPerson_OY(float angle)
        {
            ...
            forward = glm::normalize(glm::vec3(newvect));
            newvect = glm::rotate(glm::mat4(1.0f), angle, glm::vec3(0, 1, 0)) * glm::vec4(right, 1);
        ...
        //    // to normalize the vectors!
            ...
            glm::vec4 newvect = glm::rotate(glm::mat4(1.0f), angle, glm::vec3(0, 1, 0)) * glm::vec4(right, 1);
            right = glm::normalize(glm::vec3(newvect));
            up = glm::cross(right, forward);
        }
